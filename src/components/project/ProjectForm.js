...
export default function ProjectForm({handleSubmit, btnText, projectData}) {
    ...
    return (
        <form onSubmit={submit} >
            <Input type='text' text='Nome do Projeto' name='name' placeholder='Insiga o nome do projeto' 
            handleOnChange={handleChange} value={project.name ? project.name : ''}/>

            <Input type='number' text='Orçamento do projeto' name='budget' placeholder='Insiga o orçamento total' 
